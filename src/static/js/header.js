        ...
        var h = [
            ...
            '<div id="asm-topline-help-body" class="asm-menu-body">',
                '<ul class="asm-menu-list">',
                    ...
                    '<li class="asm-menu-item"><a href="http://asmdo22.fridaydigital.co.uk/service?account=bghrc&amp;method=online_form_html&amp;formid=32" target="_blank" rel="noopener"><nobr><span class="asm-icon asm-icon-link"></span> ' + _("Hedgehog Finder Form") + '</nobr></a></li>',
                    '<li class="asm-menu-item"><a href="http://asmdo22.fridaydigital.co.uk/service?account=bghrc&amp;method=online_form_html&amp;formid=28" target="_blank" rel="noopener"><nobr><span class="asm-icon asm-icon-log"></span> ' + _("Submit a bug report") + '</nobr></a></li>',
                '</ul>',
            '</div>',
