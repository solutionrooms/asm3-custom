            ...
            return [
                ...
                tableform.render_tabs([
                    ...
                    { id: "tab-animalemblems", title: _("Animal Emblems"), fields: [
                        ...
                        { id: "showborninshelter", post_field: "EmblemBornInShelter", label: html.icon("litter") + " " + _("Born in Shelter"), type: "check" },
                        { id: "borninshelterentryreason", post_field: "BornInShelterEntryReasonID", label: _("Entry category to mark as born in shelter"), type: "select", options: html.list_to_options(controller.entryreasons, "ID", "REASONNAME") },
                        { type: "nextcol" },
                    ...
                    { id: "tab-defaults", title: _("Defaults"), info:_("These are the default values for these fields when creating new records."), fields: [
                        ...
                        { id: "disableadoptionchecks", post_field: "DisableAdoptionChecks", label: _("Hide adoption readiness warnings"), type: "check", fullrow: true }, 
